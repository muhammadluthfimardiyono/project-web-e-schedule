...
<section class="section">
    <div class="section-header">
        ...
        <h1>Tambahkan Petugas MC Sholat Jumat</h1>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?=site_url('ptgas_mc')?>" method="post" autocomplete="off">
                <?= csrf_field()?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_mc" class="form-control" required autofocus>
                </div>
